	...
	def __init__(self, tab_path, txt_path):
		...
		with open(tab_path, "r") as file:
			...
			for line in file[1:]:
				...
				self.tab.append(line.split())
				self.tab[-1][0] = self.tab[-1][0].replace('S', '')
